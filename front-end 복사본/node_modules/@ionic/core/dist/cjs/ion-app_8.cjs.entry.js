...
const index$3 = require('./index-905e8955.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-dbe2342f.js'); }).then((module) => module.startStatusTap());
                }
                ...
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-4cb049f1.js'); });
