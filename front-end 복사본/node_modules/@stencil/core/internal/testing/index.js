...
const createElm = (e, t, a, o) => {
 ...
 (appData.BUILD.scoped || appData.BUILD.shadowDom) && (scopeId = i["s-sc"]), useNativeShadowDom = exports.supportsShadow && !!(1 & p.$flags$), 
   ...
   (appData.BUILD.prop || appData.BUILD.state) && (31 & o || (!appData.BUILD.lazyLoad || 2 & a) && 32 & o) ? Object.defineProperty(s, e, {
    ...
    set(s) {
     if (appData.BUILD.isDev) {
      ...
      1 & a || 0 !== (s && 8 & s.$flags$) || !(31 & o) || 1024 & o || consoleDevWarn(`@Prop() "${e}" on <${t.$tagName$}> is immutable but was modified from within the component.\nMore information: https://stenciljs.com/docs/properties#prop-mutability`);
     }
     setValue(this, e, s, t);
    },
    configurable: !0,
