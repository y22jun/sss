/*!
 Stencil Testing v4.12.6 | MIT Licensed | https://stenciljs.com
 */
  ...
  await initPageEvents(t), function r(e) {
   ...
   "true" === t.__STENCIL_SCREENSHOT__ ? e.compareScreenshot = (s, r) => {
    ...
    return i.screenshotDescriptions.add(o), async function l(e, t, s, r, i) {
     ...
     }(i), u = await e.screenshot(l), h = "number" == typeof i.pixelmatchThreshold ? i.pixelmatchThreshold : o.pixelmatchThreshold;
     let p = n.viewport.width, d = n.viewport.height;
     return i && i.clip && ("number" == typeof i.clip.width && (p = i.clip.width), "number" == typeof i.clip.height && (d = i.clip.height)), 
     await compareScreenshot(n, o, u, s, p, d, r, h);
    }(e, t, o, a, n);
